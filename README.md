...
```bash
# Via terminal (um comando, v1.0.25):
curl -L https://github.com/disouz4-dev/falaai/releases/download/v1.0.25/falaai_1.0.25_amd64.deb -o falaai_1.0.25_amd64.deb && sudo dpkg -i falaai_1.0.25_amd64.deb && sudo apt-get install -f
# Ou manual:
sudo dpkg -i falaai_1.0.25_amd64.deb && sudo apt-get install -f
```
