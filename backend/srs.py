"""
PT-BR: Repetição espaçada do OpenLingo, inspirada no Half-Life Regression do Duolingo
...
EN:    OpenLingo spaced repetition, inspired by Duolingo's Half-Life Regression. Each word has a
       memory half-life (days); recall probability decays as 2^(-Δ/half-life). Correct → half-life
       grows; wrong → resets.
"""
