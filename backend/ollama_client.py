"""
PT-BR: Cliente do Ollama para o OpenLingo. Fala com o modelo local 'small-english-teacher'
       tanto para conversação em tempo real (streaming) quanto para gerar itens/relatórios.
EN:    Ollama client for OpenLingo. Talks to the local 'small-english-teacher' model for both
...
MODEL = os.environ.get("OPENLINGO_MODEL", "small-english-teacher")
